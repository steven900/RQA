...
[@html]
	...
	<div class="main">
			...
			<div class="in_main">
				...
				<form  action="/manage/properties/save.do" method="post" onSubmit="">
					[#if properties && properties.id]<input type="hidden" name="id"  value="${properties.id}"/>[/#if]
					<input type="hidden" name="forwardUrlBack"  value="${forwardUrlBack}"/>
					<table width="100%">
					<tr><th class="w100">名称</th><td><input type="text" name="name" id="name"  value="[#if properties]${properties.name}[/#if]"/></td></tr>
					<tr><th class="w100">参数名称</th><td><input type="text" name="paramname" id="paramname"  value="[#if properties]${properties.paramname}[/#if]"/></td></tr>
					[#--<tr><th class="w100">类别</th><td><input type="text" name="ptype" id="ptype"  value="[#if properties]${properties.ptype}[/#if]"/></td></tr>--]
					<tr>
						<th></th>
						<td colspan="3">
						<div class="fl">
