                       		...
                       		[#if list]
	                            ...
	                            <div class="form-group" >
	                                <div class="col-sm-12" style="margin-top:20px;">
										...
										<br/>
										[#if t.state ==0]
										<a href="/manage/bug/updateMyreport.do?state=2&id=${t.id}&projectid=${t.projectid}" class="btn btn-primary btn-sm" style="margin-left:10px;margin-top:10px;"><i class="glyphicon glyphicon-check"></i>确认修复 </a
										[/#if]
	                                </div>
	                            </div>
