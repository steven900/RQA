...
[#ftl]
	...
	<tr>
		...
		<td>
			<div style="display:none;">
				<input type="text" name="length" value="200" style="width:50px;"/>
			</div>
		</td>
		<td>
			<input type="text" name="name" value="addtime" style="width:100px;"/>
		</td>
		<td>
			<input type="text" name="alias" value="添加时间" style="width: 100px;" />
	</td>
		<td style="display:none;">
		 <div style="display:none;">
			<select name="pro">
