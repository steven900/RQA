[#ftl]
	...
	<tr>
		...
		<td>
			<input type="text" name="length" value="12" style="width:50px;"/>
		</td>
		<td>
		<input type="text" name="name" value="pid" style="width:100px;"/>
		</td>
		<td>
		<input type="text" name="alias" value="父类关联pid" style="width:100px;"/>
		</td>
		<td style="display:none;">
			<div style="display:none;">
				<select name="pro">
