            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	[#if Session.auth==1]
                        <div class="">
                            <a href="/manage/projectment/edit.do?forwardUrl=${forwardUrl}" class="btn btn-primary ">添加</a>
                        </div>
                       [/#if]
                        ...
                        <table class="table table-striped table-bordered table-hover " id="editable">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>${type.brief}</td>
                                    <td>
                                    	<a href="/manage/price/pricelist.do?projectid=${type.id}" target="_blank">报价</a> &nbsp;&nbsp;&nbsp;
                                    	<a href="/manage/price/pricereport.do?projectid=${type.id}" target="_blank">查看</a>
                                    </td>
                                    <td>[#if type.addtime??]${type.addtime?string('yyyy-MM-dd')}[/#if]	</td>
                                   [#if Session.auth==1]
                                    <td class="center">
                                    	<a href="/manage/projectment/edit.do?id=${type.id}&forwardUrl=${forwardUrl}"><i class="glyphicon glyphicon-pencil"></i></a>
                                    	&nbsp;&nbsp;
                                    	<a href="/manage/projectment/delete.do?id=${type.id}&forwardUrl=${forwardUrl}"><i class="glyphicon glyphicon-remove"></i></a>
