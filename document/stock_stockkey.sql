...
--
-- Dumping data for table `stockkey`
--

LOCK TABLES `stockkey` WRITE;
/*!40000 ALTER TABLE `stockkey` DISABLE KEYS */;
INSERT INTO `stockkey` VALUES ('北京银行',601169,1,1,NULL),('佛山照明',541,1,2,NULL);
/*!40000 ALTER TABLE `stockkey` ENABLE KEYS */;
UNLOCK TABLES;
