                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="/framework/hplus/table_data_tables.html#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="/framework/hplus/table_data_tables.html#">选项1</a>
                                </li>
                                <li><a href="/framework/hplus/table_data_tables.html#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
